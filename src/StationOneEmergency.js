...
//         const q = query(collection(db, 'emergencies'), where('nearestPoliceStation.name', '==', 'Police Station 1'));
...
//           nearestPoliceStation: doc.data().nearestPoliceStation,
...
//   return (
//     <div>
//       <h1>Emergencies at Police Station 1</h1>
...
//               <td style={{ border: '1px solid black', padding: '8px' }}>{emergency.status.toString()}</td>
